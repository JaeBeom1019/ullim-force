      ...
      <section className="py-16">
        <div className="max-w-[120rem] mx-auto px-6 lg:px-12">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 className="font-heading text-4xl md:text-5xl text-secondary mb-6">{"우리의 이야기"}</h2>
            <p className="font-paragraph text-lg text-light-gray/90 mb-6 leading-relaxed">{"체계적인 시스템 위에서 피어나는 역동적인 드라마!"}</p>
